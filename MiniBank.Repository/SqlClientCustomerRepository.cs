...
{
    public class SqlClientCustomerRepository : Repository<Customer>, ICustomerRepository
    {

        public SqlClientCustomerRepository() : base("Server=DESKTOP-VU8IK37\\SQLEXPRESS;Database=MiniBank;Trusted_Connection=true;TrustServerCertificate=true")
        {
